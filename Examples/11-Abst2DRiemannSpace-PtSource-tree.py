...
simulation_id = 1
model_filename = '11-Abst2DRiemannSpace-PtSource-tree.lpy'
PrefixDir = 'Abst2DRiemannSpaceTreePtSource/tree-ptsource-'
...
i = 0
for x in STEPS:
    lsys = lpy.Lsystem(model_filename, {'TREE': True, 'FIELD_STRENGTH':x})
